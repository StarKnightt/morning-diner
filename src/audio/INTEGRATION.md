...
audio.sfx.mugClink({ x, y, z });          // ceramic ping over a 10 ms contact thock, ≈ -30 dBFS at arm's length
...
audio.sfx.setOutside(1, 0.7);             // or: one call, rise in 0.7 s, holds level until setOutside(0)
...
≈ -39 dBFS RMS at arm's length (about 5 dB under the bed, with a 3 dB louder
first splash); the latch click peaks ≈ -30 dBFS from mid-room. The coffee
warmer's thermostat ticks peak ≈ -39 dBFS mid-room and its gurgles sit at
-42..-46 dBFS in 80–600 Hz; with the door open the exterior holds 60–250 Hz at
≈ -51, 300 Hz–1 kHz at ≈ -57 and cicadas (4.5–6 kHz) at ≈ -45 dBFS. The
limiter never engages in the ambience.
